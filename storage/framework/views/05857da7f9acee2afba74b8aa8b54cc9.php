...
<body class="h-full bg-stone-50 antialiased">
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-stone-200 flex space-x-6 overflow-x-auto p-2 md:hidden z-50">
        ...
        <a href="<?php echo e(route('discover.index')); ?>" class="flex flex-col items-center text-stone-600 hover:text-amber-600">
        ...
        <a href="<?php echo e(route('events.index')); ?>" class="flex flex-col items-center text-stone-600 hover:text-amber-600">
            <i data-lucide="calendar" class="w-6 h-6"></i>
            <span class="text-xs">Events</span>
        </a>
        <a href="<?php echo e(route('messages.index')); ?>" class="flex flex-col items-center text-stone-600 hover:text-amber-600">
            <i data-lucide="message-circle" class="w-6 h-6"></i>
            <span class="text-xs">Messages</span>
        </a>
        <a href="<?php echo e(route('profile.show')); ?>" class="flex flex-col items-center text-stone-600 hover:text-amber-600">
    ...
    <div id="createPostModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden items-center justify-center p-4">
        ...
        <form action="<?php echo e(route('timeline.store')); ?>" method="POST" enctype="multipart/form-data" class="p-4 md:p-6 space-y-4 text-sm md:text-base">
            ...
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    <p class="font-semibold text-stone-800 text-sm md:text-base"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-xs md:text-sm text-stone-500">@ <?php echo e(auth()->user()->username); ?></p>
                </div>
            </div>
...
<?php /**PATH C:\Laravel\Timeline\resources\views/layouts/app.blade.php ENDPATH**/ ?>