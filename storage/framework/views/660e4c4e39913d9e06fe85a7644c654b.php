        ...
        <div class="mb-4 relative">
            ...
            <div class="mt-1 relative">
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                    class="pl-10 block w-full rounded-xl border border-stone-300 focus:ring-amber-500 focus:border-amber-500 text-stone-700 placeholder-stone-400 py-3"
                    placeholder="name">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\resources\views/register.blade.php ENDPATH**/ ?>