                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-[10px] font-bold text-stone-400 uppercase tracking-widest">
                                        <?php echo e($culture->submitter->name ?? 'Guardian'); ?>
                            ...
                            <div class="flex items-center justify-between gap-3">
                                <?php if(auth()->guard()->check()): ?>
                                    <button onclick="toggleCultureLockin(<?php echo e($culture->id); ?>)" data-culture-lockin="<?php echo e($culture->id); ?>"
                                        class="flex-1 flex items-center justify-center space-x-2 py-2.5 rounded-xl font-bold text-xs transition-all duration-200 <?php echo e(auth()->user()->hasLockedIn($culture) ? 'bg-amber-600 text-white shadow-md' : 'bg-stone-100 text-stone-600 hover:bg-stone-200'); ?>">
                                        <i data-lucide="<?php echo e(auth()->user()->hasLockedIn($culture) ? 'check' : 'lock'); ?>" class="w-3.5 h-3.5"></i>
