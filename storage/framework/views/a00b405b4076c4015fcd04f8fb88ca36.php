    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div class="flex items-center text-xs uppercase tracking-widest text-stone-400 space-x-2">
                <a href="<?php echo e(route('cultural-hub.index')); ?>" class="hover:text-amber-500 transition">
                    Cultural Hub
                </a>
            ...
            <button onclick="toggleCultureLockin(<?php echo e($culture->id); ?>)"
                ...
                <i data-lucide="<?php echo e(auth()->user()->hasLockedIn($culture) ? 'check' : 'lock'); ?>"
            ...
            <div class="lg:col-span-7 space-y-8">
                ...
                <div x-data="{ activeImage: '<?php echo e(Storage::url($culture->media_files[0])); ?>' }"
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        ...
                        <button @click="activeImage = '<?php echo e(Storage::url($file)); ?>'"
                            ...
                            <img src="<?php echo e(Storage::url($file)); ?>" class="w-full h-16 object-cover">
                        </button>
                ...
                <div class="bg-[#141419] border border-white/5 p-6 rounded-2xl shadow-xl">
                    ...
                    <div class="aspect-video rounded-xl overflow-hidden">
                        ...
                        <?php else: ?>
                            <iframe src="<?php echo e($culture->video_url); ?>" class="w-full h-full" allowfullscreen></iframe>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="lg:col-span-5 space-y-6 order-first lg:order-none">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-center">
                        <div>
                            <div class="text-3xl font-bold">
                                <?php echo e($culture->locked_in_count); ?>
                        ...
                        <div>
                            <div class="text-3xl font-bold">
                                <?php echo e($culture->resonance_count); ?>
                ...
                <div class="bg-[#141419] border border-white/5 p-6 rounded-2xl shadow-xl">
                    ...
                    <p class="font-semibold">
                        <?php echo e($culture->submitter->name ?? 'Timeline Preserver'); ?>
                    ...
                    <div class="mt-4 text-xs text-stone-400 space-y-2">
                        <div class="flex justify-between">
                            <span>Enshrined</span>
                            <span><?php echo e($culture->created_at->format('M d, Y')); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span>Archive ID</span>
                            <span>#<?php echo e(str_pad($culture->id, 5, '0', STR_PAD_LEFT)); ?></span>
                        </div>
                    </div>
                ...
                <div class="bg-[#141419] border border-white/5 p-5 rounded-xl text-xs text-stone-400">
                    ...
                    <span class="text-amber-500 font-semibold">
                        <?php echo e($culture->license_type ?? 'Standard'); ?>
