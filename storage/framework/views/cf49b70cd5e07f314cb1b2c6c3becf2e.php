        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white dark:bg-stone-900 rounded-2xl shadow hover:shadow-lg transition p-4 sm:p-5 flex flex-col justify-between border dark:border-stone-800">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-xs sm:text-sm mb-4 leading-snug"><?php echo e(Str::limit($item->description, 100)); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Timeline\resources\views/vault/index.blade.php ENDPATH**/ ?>