            ...
            <div class="mb-4">
                ...
                <div class="mt-1 relative">
                    ...
                    <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                        class="pl-10 py-3 block w-full rounded-xl border border-stone-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-amber-500 focus:outline-none placeholder-stone-400"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Timeline\resources\views/auth/login.blade.php ENDPATH**/ ?>