<?php $__env->startSection('content'); ?>
  <div class="max-w-3xl mx-auto bg-white dark:bg-stone-900 border border-stone-100 dark:border-stone-800 shadow-lg rounded-2xl p-6 sm:p-8 mt-10">
    <h2 class="text-3xl font-bold mb-8 text-gray-800 dark:text-stone-100">
      <?php echo e(isset($community_id) ? 'Schedule Community Meeting' : 'Create Event'); ?>

    </h2>

    <form action="<?php echo e(route('events.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
      <?php echo csrf_field(); ?>

      <?php if(isset($community_id)): ?>
          <input type="hidden" name="community_id" value="<?php echo e($community_id); ?>">
      <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div>
        ...
        <textarea name="description" id="description" rows="4"
          class="w-full border border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 rounded-xl px-4 py-3 focus:ring-2 focus:ring-amber-500 focus:outline-none"
          placeholder="Provide more details..." required><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="date" name="event_date" id="event_date" value="<?php echo e(old('event_date')); ?>"
...
unset($__errorArgs, $__bag); ?>
          ...
          <div>
            ...
            <input type="time" name="event_time" id="event_time" value="<?php echo e(old('event_time')); ?>"
              class="w-full border border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 rounded-xl px-4 py-3 focus:ring-2 focus:ring-amber-500 focus:outline-none" required>
      ...
      <div class="space-y-4 border border-stone-200 dark:border-stone-800 rounded-xl p-5 bg-stone-50 dark:bg-stone-800/30">
        <div>
            <label class="flex items-center gap-3 cursor-pointer">
                ...
                <input type="checkbox" name="is_online" value="1" id="is_online" class="w-5 h-5 rounded border-stone-300 text-amber-500 focus:ring-amber-500" <?php echo e(old('is_online') ? 'checked' : ''); ?> onchange="toggleOnlineFields()">
        ...
        <div id="location-field">
            ...
            <input type="text" name="location" id="location" value="<?php echo e(old('location', 'Online')); ?>"
            class="w-full border border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 rounded-xl px-4 py-3 focus:ring-2 focus:ring-amber-500 focus:outline-none"
...
unset($__errorArgs, $__bag); ?>
          ...
          <div>
            ...
            <div class="relative">
                ...
                <input type="number" name="price" id="price" value="<?php echo e(old('price', 0)); ?>" step="0.01" min="0"
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/30 rounded-2xl p-6">
        <label class="flex items-center gap-4 cursor-pointer">
            ...
            <input type="checkbox" name="accepts_contributions" value="1" <?php echo e(old('accepts_contributions') ? 'checked' : ''); ?>
            ...
            <div>
                ...
                <span class="block text-stone-600 dark:text-stone-400 text-sm">Allow attendees and viewers to send voluntary donations to support this <?php echo e(isset($community_id) ? 'meeting' : 'event'); ?>.</span>
            </div>
        </label>
      </div>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="pt-4 border-t border-stone-100 dark:border-stone-800">
        <button type="submit"
          ...
          <?php echo e(isset($community_id) ? 'Schedule Meeting' : 'Create Event'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Timeline\resources\views/events/create.blade.php ENDPATH**/ ?>