...
<div class="max-w-4xl mx-auto p-0 sm:p-4 space-y-6">
    ...
    <div class="flex flex-col items-center pt-8">
        ...
        <div class="text-center mt-4">
            <h1 class="text-lg sm:text-xl font-semibold text-stone-800"><?php echo e($user->name); ?></h1>
            ...
            <div class="bg-stone-50 p-3 rounded-xl border border-stone-100 flex flex-col sm:flex-row justify-between items-start gap-3">
                <div class="flex gap-3 items-start flex-1">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-stone-400 mt-1"><?php echo e($chapter->location ?? 'Jos, Nigeria'); ?> • <?php echo e($chapter->stories_count ?? 0); ?> Stories</p>
                    </div>
                </div>
                <span class="text-xs text-stone-400 mt-1 sm:mt-0"><?php echo e($chapter->start_year); ?> - <?php echo e($chapter->end_year ?? 'Present'); ?></span>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\resources\views/profile/index.blade.php ENDPATH**/ ?>