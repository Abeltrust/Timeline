            ...
            messageDiv.innerHTML = `
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <div class="flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    ...
                                    <button onclick="initiateReply('<?php echo e(auth()->user()->name); ?>', this)" class="p-1.5 rounded-lg hover:bg-white/10 text-stone-500 hover:text-amber-500 transition" title="Reply">
