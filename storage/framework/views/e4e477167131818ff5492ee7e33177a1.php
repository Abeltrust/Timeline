    ...
    <div id="live-stream-root" class="h-[calc(100vh-4rem)] bg-stone-950 flex flex-col md:flex-row overflow-hidden relative"
        ...
        <div class="flex-1 flex flex-col relative transition-all duration-300 h-[60vh] md:h-full">
            ...
            <div class="w-full h-full bg-black relative flex items-center justify-center overflow-hidden">
                <?php if(auth()->id() === $stream->user_id && $stream->is_live): ?>
                    <video id="host-video" autoplay playsinline muted class="w-full h-full object-cover"></video>
                <?php else: ?>
                    <img src="<?php echo e($stream->thumbnail ?? 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?auto=format&fit=crop&q=80&w=1200'); ?>"
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <a href="<?php echo e(route('profile.user', $stream->host)); ?>" class="text-stone-300 text-sm flex items-center gap-2 hover:text-amber-500 transition-colors group">
                    ...
                    <div class="flex items-center gap-2">
                        <div
                            ...
                            <i data-lucide="eye" class="w-4 h-4 text-stone-300"></i> <?php echo e($stream->viewers_count); ?>
                ...
                <?php if(auth()->id() === $stream->user_id && $stream->is_live): ?>
                    <div class="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex items-center gap-4 bg-black/60 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/10"
                        ...
                        <form action="<?php echo e(route('live-stream.end', $stream)); ?>" method="POST" class="inline"
                            id="end-stream-form">
                            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('chatComponent', () => ({
                ...
                endStreamBeacon() {
                    const url = "<?php echo e(route('live-stream.ajax-end', $stream)); ?>";
                                ...
                                <div class="flex items-start gap-2">
                                    <div class="flex-1 bg-white/5 rounded-2xl rounded-tl-none p-3 border border-white/5">
                                        <div class="flex items-center justify-between mb-1">
                                            <span class="text-amber-500 font-bold text-xs"><?php echo e(auth()->user()->name); ?></span>
                                    ...
                                    <div class="flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <button onclick="initiateReplyFromGlobal('${'<?php echo e(auth()->user()->name); ?>'}')" class="p-1.5 rounded-lg hover:bg-white/10 text-stone-500 hover:text-amber-500 transition" title="Reply">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Timeline\resources\views/live-streaming/show.blade.php ENDPATH**/ ?>