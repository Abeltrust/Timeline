                            ...
                            <?php if($event->image): ?>
                                <div class="h-48 w-full overflow-hidden relative">
                                    ...
                                    <div class="absolute top-4 right-4 flex flex-col items-end gap-2">
                                        <span class="bg-white/90 dark:bg-stone-900/90 backdrop-blur px-3 py-1 rounded-full text-[10px] font-black uppercase text-stone-600 dark:text-stone-300 border border-stone-200 dark:border-stone-800"><?php echo e($event->type); ?></span>
                                        <?php if($event->price > 0): ?>
                                            <span class="bg-amber-500 text-white px-3 py-1 rounded-full text-[10px] font-black uppercase border border-amber-400 shadow-lg shadow-amber-500/20">$<?php echo e(number_format($event->price, 2)); ?></span>
                                        <?php else: ?>
