    ...
    <div class="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <div class="bg-white dark:bg-stone-900 rounded-2xl shadow-md border border-stone-100 dark:border-stone-800 p-4">
                ...
                <p class="text-2xl font-bold text-stone-900 dark:text-stone-100 mt-2"><?php echo e($stats['total_stories']); ?></p>
            ...
            <div class="bg-white dark:bg-stone-900 rounded-2xl shadow-md border border-stone-100 dark:border-stone-800 p-4">
                ...
                <p class="text-2xl font-bold text-stone-900 dark:text-stone-100 mt-2"><?php echo e($stats['taps_received']); ?></p>
            ...
            <div class="bg-white dark:bg-stone-900 rounded-2xl shadow-md border border-stone-100 dark:border-stone-800 p-4">
                ...
                <p class="text-2xl font-bold text-stone-900 dark:text-stone-100 mt-2"><?php echo e($stats['locked_in_connections']); ?>
            ...
            <div class="bg-white dark:bg-stone-900 rounded-2xl shadow-md border border-stone-100 dark:border-stone-800 p-4">
                ...
                <p class="text-2xl font-bold text-stone-900 dark:text-stone-100 mt-2"><?php echo e($stats['story_views']); ?></p>
            ...
            <div class="bg-white dark:bg-stone-900 rounded-2xl shadow-md border border-stone-100 dark:border-stone-800 p-4">
                ...
                <p class="text-2xl font-bold text-stone-900 dark:text-stone-100 mt-2"><?php echo e($stats['resonance_points']); ?></p>
            ...
            <div class="bg-white dark:bg-stone-900 rounded-2xl shadow-md border border-gray-100 dark:border-stone-800 p-4">
                <div class="flex items-center gap-3">
                    <i data-lucide="globe" class="w-6 h-6 text-gray-500 dark:text-stone-400"></i>
                    <p class="text-sm font-medium text-gray-600 dark:text-stone-400">Cultural Contributions</p>
                </div>
                <p class="text-2xl font-bold text-gray-900 dark:text-stone-100 mt-2"><?php echo e($stats['cultural_contributions']); ?>

                </p>
                <p class="text-xs text-gray-600 dark:text-stone-500 mt-1">+67%</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <?php $__currentLoopData = $topStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <div>
                                <p class="text-sm font-medium text-stone-800 dark:text-stone-200"><?php echo e($story['title']); ?></p>
                            ...
                            <p class="text-xs text-stone-400 dark:text-stone-600"><?php echo e($story['date']); ?></p>
                        </div>
            ...
            <!-- CULTURAL IMPACT -->
            <div
                class="bg-white dark:bg-stone-900 rounded-2xl p-6 shadow border border-gray-100 dark:border-stone-800 space-y-6">
                <h2 class="text-lg font-semibold text-gray-800 dark:text-stone-100 mb-2 flex items-center gap-2">
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $culturalImpact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $impact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            class="p-4 border border-yellow-100 dark:border-amber-900/30 rounded-lg bg-yellow-50 dark:bg-amber-900/10">
                            <p class="font-medium text-gray-800 dark:text-stone-200"><?php echo e($impact['culture']); ?></p>
                            <p class="text-xs text-gray-600 dark:text-stone-500">
                ...
                <!-- PRESERVATION SCORE -->
                <div
                    class="p-4 rounded-lg bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-900/30">
                    <p class="font-medium text-gray-800 dark:text-stone-200 flex items-center gap-2">
                        <i data-lucide="shield-check" class="w-5 h-5 text-green-600 dark:text-green-500"></i>
                        Heritage Preservation Score
                    </p>
                    <p class="text-2xl font-bold text-green-700 dark:text-green-500 mt-1"><?php echo e($preservationScore); ?>/100</p>
                    <p class="text-xs text-green-600 dark:text-green-500">Exceptional cultural preservation impact</p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Timeline\resources\views/analytics/index.blade.php ENDPATH**/ ?>