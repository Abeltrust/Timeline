        ...
        <div class="max-w-4xl mx-auto p-3 sm:p-6 space-y-4 sm:space-y-6 w-full box-border">
                            ...
                            <div class="mt-4 sm:mt-5 flex flex-wrap justify-center gap-2 sm:gap-3 w-full max-w-sm mx-auto">
                                ...
                                <button onclick="toggleUserTap(<?php echo e($user->id); ?>)" id="profile-vibe-btn"
                                    class="flex items-center justify-center space-x-1.5 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs font-semibold transition-all shadow-sm flex-1 sm:flex-none
                                                                                                                <?php echo e(isset($hasVibed) && $hasVibed ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-500 hover:bg-amber-200' : 'bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 text-stone-700 dark:text-stone-300 hover:bg-stone-50'); ?>">
                                ...
                                <button onclick="toggleUserLockIn(<?php echo e($user->id); ?>)" id="profile-lockin-btn"
                                    class="flex items-center justify-center space-x-1.5 px-4 sm:px-6 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all shadow-sm flex-1 sm:flex-none
                                                                                                                <?php echo e(isset($isLockedIn) && $isLockedIn ? 'bg-stone-100 dark:bg-stone-800 text-stone-700 dark:text-stone-300 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600' : 'bg-gradient-to-r from-amber-500 to-orange-600 text-white hover:shadow-md hover:scale-[1.02]'); ?>">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-center mb-2">
                <div
                    ...
                    <p class="text-lg sm:text-2xl font-black text-stone-800 dark:text-stone-100"><?php echo e($user->posts_count ?? 0); ?></p>
                ...
                <div
                    class="bg-white dark:bg-stone-900 rounded-2xl sm:rounded-3xl shadow-sm p-3 sm:p-5 border border-stone-100 dark:border-stone-800 transition hover:shadow-md">
                    <p class="text-lg sm:text-2xl font-black text-stone-800 dark:text-stone-100"><?php echo e($user->cultures_contributed ?? 0); ?></p>
                    <p
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Timeline\resources\views/profile/index.blade.php ENDPATH**/ ?>