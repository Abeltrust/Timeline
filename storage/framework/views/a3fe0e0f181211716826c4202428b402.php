            ...
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php if($tab === 'stories'): ?>
                    <div class="bg-white dark:bg-stone-900 rounded-xl sm:rounded-2xl shadow-sm overflow-hidden border border-stone-200 dark:border-stone-800">
                        ...
                        <div class="p-3 sm:p-4">
                            ...
                            <p class="text-xs sm:text-sm text-stone-500 dark:text-stone-400 line-clamp-2"><?php echo e(Str::limit($item->content, 80)); ?></p>
                ...
                <?php elseif($tab === 'cultures'): ?>
                    <div class="bg-white dark:bg-stone-900 rounded-xl sm:rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 p-3 sm:p-4">
                        <h3 class="font-semibold text-stone-800 dark:text-stone-100 text-sm sm:text-base"><?php echo e($item->name); ?></h3>
                        <p class="text-xs sm:text-sm text-stone-500 dark:text-stone-400"><?php echo e(Str::limit($item->description, 80)); ?></p>
                    </div>
                ...
                <?php elseif($tab === 'places'): ?>
                    <div class="bg-white dark:bg-stone-900 rounded-xl sm:rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 overflow-hidden">
                        <div class="p-3 sm:p-4">
                            <h3 class="font-semibold text-stone-800 dark:text-stone-100 text-sm sm:text-base"><?php echo e($item->title); ?></h3>
                            <p class="text-xs sm:text-sm text-stone-500 dark:text-stone-400"><?php echo e($item->location); ?></p>
