                        ...
                        <a href="<?php echo e(route('live-stream.show', $stream)); ?>"
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute bottom-3 left-3 right-3 text-white">
                                    ...
                                    <p class="text-xs text-stone-300 mt-1 line-clamp-1"><?php echo e($stream->host->name); ?></p>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="flex-1 flex flex-col justify-center">
                                ...
                                <p class="text-sm text-stone-500 dark:text-stone-400 mb-2">Hosted by <span
                                        class="font-medium text-stone-700 dark:text-stone-300"><?php echo e($stream->host->name); ?></span></p>
