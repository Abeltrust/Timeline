        ...
        <div>
            ...
            <ul class="grid gap-3 sm:gap-4 grid-cols-2 sm:grid-cols-2">
                ...
                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <input type="radio" id="<?php echo e($type['id']); ?>" name="type" value="<?php echo e($type['id']); ?>" class="hidden peer">
        ...
        <div>
            ...
            <ul class="grid grid-cols-2 gap-3 sm:gap-4">
                ...
                <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <input type="radio" id="<?php echo e($level['id']); ?>" name="access_level" value="<?php echo e($level['id']); ?>" class="hidden peer">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\resources\views/vault/create.blade.php ENDPATH**/ ?>