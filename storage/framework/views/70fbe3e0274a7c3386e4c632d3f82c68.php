...
<?php $__env->startSection('title', 'Refine Heritage Story - Cultural Hub'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <form action="<?php echo e(route('cultural-hub.update', $culture->id)); ?>" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="name"
                                ...
                                Name</label>
                            <input type="text" name="name" id="name" required value="<?php echo e(old('name', $culture->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="region" id="region" required
                                value="<?php echo e(old('region', $culture->region)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="category" id="category" required
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat); ?>" <?php echo e((old('category', $culture->category) === $cat) ? 'selected' : ''); ?>>
                    ...
                    <!-- Description -->
                    <div x-data="{ 
                                            content: <?php echo \Illuminate\Support\Js::from(old('description', $culture->description))->toHtml() ?>,
                                            wordCount() {
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="pt-10 border-t border-stone-100 space-y-6"
                    x-data="{ mode: '<?php echo e($culture->video_url ? 'link' : 'file'); ?>' }">
                    ...
                    <div x-show="mode === 'file'">
                        ...
                        <?php if($culture->video_path): ?>
                            <p class="text-[9px] font-black text-amber-600 mb-2 uppercase tracking-widest">CURRENT:
                                <?php echo e(basename($culture->video_path)); ?></p>
                        <?php endif; ?>
                        <div
                    ...
                    <div x-show="mode === 'link'" x-cloak>
                        ...
                        <input type="url" name="video_url" id="video_url" class="w-full stnd-input py-3 px-4"
                            placeholder="YouTube or Vimeo link..." value="<?php echo e(old('video_url', $culture->video_url)); ?>">
                    </div>

                    <textarea name="video_description" rows="2" class="w-full stnd-input py-3 px-4 text-sm"
                        placeholder="Tell us what makes this video special..."><?php echo e(old('video_description', $culture->video_description)); ?></textarea>
                </div>

                <!-- Audio Section -->
                <div class="pt-10 border-t border-stone-100 space-y-6"
                    x-data="{ mode: '<?php echo e($culture->audio_url ? 'link' : 'file'); ?>' }">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="flex items-center space-x-2 text-amber-600 uppercase tracking-tighter text-xs font-black">
                    ...
                    <div x-show="mode === 'file'">
                        ...
                        <?php if($culture->audio_path): ?>
                            <p class="text-[9px] font-black text-amber-600 mb-2 uppercase tracking-widest">CURRENT:
                                <?php echo e(basename($culture->audio_path)); ?></p>
                        <?php endif; ?>
                        <div
                            class="border-2 border-amber-200 border-dashed rounded-[1.5rem] p-8 text-center hover:border-amber-400 transition-colors bg-amber-50/30">
                    ...
                    <div x-show="mode === 'link'" x-cloak>
                        ...
                        <input type="url" name="audio_url" id="audio_url" class="w-full stnd-input py-3 px-4"
                            placeholder="SoundCloud or Podcast link..." value="<?php echo e(old('audio_url', $culture->audio_url)); ?>">
                    </div>

                    <textarea name="audio_description" rows="2" class="w-full stnd-input py-3 px-4 text-sm"
                        placeholder="Tell us about this sound recording..."><?php echo e(old('audio_description', $culture->audio_description)); ?></textarea>
                </div>
                            ...
                            <div>
                                ...
                                <?php if($culture->image): ?>
                                    <div class="mb-4 aspect-video rounded-xl overflow-hidden border border-amber-200">
                                        <img src="<?php echo e(Storage::url($culture->image)); ?>" class="w-full h-full object-cover">
                                    </div>
                                <?php endif; ?>
                                <div
                            ...
                            <div>
                                ...
                                <select name="license_type" id="license_type"
                                    ...
                                    <?php $__currentLoopData = $licenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $license): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($license); ?>" <?php echo e((old('license_type', $culture->license_type) === $license) ? 'selected' : ''); ?>><?php echo e($license); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="text" name="license_credit" id="license_credit"
                                    ...
                                    value="<?php echo e(old('license_credit', $culture->license_credit)); ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Timeline\resources\views/cultural-hub/edit.blade.php ENDPATH**/ ?>