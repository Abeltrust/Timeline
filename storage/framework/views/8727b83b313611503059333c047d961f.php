    ...
    <div class="flex flex-wrap gap-2 sm:gap-3 mb-6">
        ...
        <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('notifications.index', ['filter' => $key])); ?>"
                ...
                <?php echo e($filter === $key ? 'bg-amber-500 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'); ?>">
                <?php echo e($label); ?>
            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 p-4 bg-white rounded-xl border shadow-sm hover:bg-gray-50 transition">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="w-10 h-10 rounded-full flex items-center justify-center shrink-0
                        <?php echo e($notification->read ? 'bg-gray-200 text-gray-500' : 'bg-amber-500 text-amber-600'); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\resources\views/notifications/index.blade.php ENDPATH**/ ?>