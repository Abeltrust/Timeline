...
<div class="flex flex-col h-[100dvh] md:h-[calc(100vh-4rem)] bg-gray-100 overflow-x-hidden font-sans w-full max-w-full box-border">

    <!-- INBOX COLUMN -->
    <div class="flex-1 flex flex-col bg-white relative h-full w-full border-x border-gray-100 shadow-sm overflow-x-hidden overflow-y-auto box-border">

        <!-- HEADER -->
        <div class="p-2 md:p-4 flex items-center justify-between border-b border-gray-100 bg-white/80 backdrop-blur-md sticky top-0 z-20">
            <h1 class="text-lg md:text-2xl font-black text-gray-900 tracking-tight truncate">Messages</h1>
            <div class="p-1.5 md:p-2 bg-amber-50 rounded-full text-amber-600 cursor-pointer hover:bg-amber-100 transition-colors">
        ...
        <div class="flex-1 overflow-y-auto space-y-1 p-1 md:p-2.5 custom-scrollbar box-border">
            <div class="px-2 py-1 text-xs font-bold text-gray-400 uppercase tracking-widest truncate">Active Conversations</div>
                ...
                <a href="<?php echo e(route('messages.start', $user->id)); ?>"
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex justify-between items-baseline mb-0.5">
                            ...
                            <span class="text-[10px] md:text-[11px] font-bold text-gray-400 uppercase tracking-tighter truncate">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="h-full flex flex-col items-center justify-center opacity-40 text-gray-400 p-8 space-y-4 truncate">
