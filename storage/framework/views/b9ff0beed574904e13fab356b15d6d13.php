        ...
        <div class="mb-4 relative">
            ...
            <div class="mt-1 relative">
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                    class="pl-10 block w-full rounded-xl border border-stone-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-amber-500 focus:outline-none placeholder-stone-400 py-3"
                    placeholder="name">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4 relative" x-data="{ show: false }">
            ...
            <div class="mt-1 relative">
                ...
                <button type="button" class="absolute inset-y-0 right-3 text-sm text-gray-500"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Timeline\resources\views/auth/register.blade.php ENDPATH**/ ?>