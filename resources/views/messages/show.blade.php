            ...
            <div class="flex items-center gap-2 md:gap-4">
                ...
                <div class="relative">
                    ...
                    <span class="absolute -bottom-1 -right-1 w-2.5 h-2.5 md:w-3.5 md:h-3.5 rounded-full border-2 border-white
                        {{ $otherUser->is_online ? 'bg-green-500' : 'bg-gray-400' }}"></span>
                </div>

                <div class="truncate max-w-[120px] md:max-w-xs">
                    <h2 class="font-extrabold text-sm md:text-lg truncate">{{ $otherUser->name ?? 'Unknown' }}</h2>
                    ...
                    <div
                        ...
                        <div
                            class="relative px-3 py-2 md:px-5 md:py-3 rounded-2xl shadow-sm text-sm md:text-[15px] leading-snug
                                {{ $msg->user_id == auth()->id() ? 'bg-amber-500 text-white rounded-br-none' : 'bg-white text-gray-800 rounded-bl-none border border-gray-100' }}">
