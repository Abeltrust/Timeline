...
<body class="h-full bg-stone-50 dark:bg-stone-900 antialiased text-stone-800 dark:text-gray-100">
    ...
    >
        <a href="{{ route('timeline.index') }}" class="flex flex-col items-center text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500">
            <i data-lucide="home" class="w-6 h-6"></i>
            <span class="text-xs">Home</span>
        </a>
        <a href="{{ route('discover.index') }}" class="flex flex-col items-center text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500">
        ...
        <a href="{{ route('cultural-hub.index') }}" class="flex flex-col items-center text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500">
            <i data-lucide="globe" class="w-6 h-6"></i>
            <span class="text-xs">Hub</span>
        </a>
        
        <a href="{{ route('communities.index') }}" class="flex flex-col items-center text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500">
            <i data-lucide="users" class="w-6 h-6"></i>
            <span class="text-xs">Communities</span>
        </a>
        <a href="{{ route('events.index') }}" class="flex flex-col items-center text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500">
            <i data-lucide="calendar" class="w-6 h-6"></i>
            <span class="text-xs">Events</span>
        </a>
        <a href="{{ route('messages.index') }}" class="flex flex-col items-center text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500">
            <i data-lucide="message-circle" class="w-6 h-6"></i>
            <span class="text-xs">Messages</span>
        </a>
        <a href="{{ route('profile.show') }}" class="flex flex-col items-center text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-500">
