...
<div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8"
     x-data="shareCulture({{ count($errors) ? session('last_step', 1) : 1 }})">
    ...
    <form action="{{ route('cultural-hub.store') }}" 
          method="POST" 
    ...
    <!-- Help Section -->
    @include('cultural-hub.steps.help')
</div>
